...
const DocumentUploadStep = ({ documentFiles, setDocumentFiles, documentErrors, setDocumentErrors }) => {
  ...
  return (
    <div className="documents-section">
      ...
      <p className="help-text" style={{ marginBottom: '1rem' }}>
        Upload your PAN Card and Driving License. Vehicle RC documents are uploaded in the Vehicles step.
